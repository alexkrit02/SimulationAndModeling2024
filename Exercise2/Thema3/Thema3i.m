...
[g1,g2] = best_g(1,a11,a12,a21,a22,b1,b2,g1_range,g2_range,u,t,theta_m);
...
yline(a11,'-k');
hold off
title('[Parallel structure] $a_{11}$ and $\hat{a_{11}}$','interpreter','latex','FontSize',20);
...
yline(a12,'-k');
hold off
title('[Parallel structure] $a_{12}$ and $\hat{a_{12}}$','interpreter','latex','FontSize',20);
...
yline(a21,'-k');
hold off
title('[Parallel structure] $a_{21}$ and $\hat{a_{21}}$','interpreter','latex','FontSize',20);
...
yline(a22,'-k');
hold off
title(' [Parallel structure] $a_{22}$ and $\hat{a_{22}}$','interpreter','latex','FontSize',20);
...
yline(b1,'-k');
hold off
title('[Parallel structure] $b_1$ and $\hat{b_1}$','interpreter','latex','FontSize',20);
...
yline(b1,'-k');
hold off
title('[Parallel structure] $b_2$ and $\hat{b_2}$','interpreter','latex','FontSize',20);
